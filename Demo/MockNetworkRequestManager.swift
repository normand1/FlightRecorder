...
func stubFactory(constainsString: String, relativePathForMockJSONFile: String, stubName: String, httpMethod: String = "GET", featureKey: String? = nil, headerResponse: [String: Any]? = nil) -> OHHTTPStubsDescriptor {
    return stub(condition: { URLRequest in 
        return URLRequest.url?.absoluteString.constainsString(constainsString)) ?? false && URLRequest.httpMethod == httpMethod
...
getHTTPBodyFromURLRequest(_ urlRequest: URLRequest) -> [String: AnyObject]? {
